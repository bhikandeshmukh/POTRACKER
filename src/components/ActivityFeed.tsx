    ...
    const mockActivities: ActivityItem[] = [
      {
        ...
        description: 'created a new purchase order for ABC Electronics Ltd',
        timestamp: new Date(Date.now() - 30 * 60 * 1000), // 30 minutes ago
        metadata: { amount: 250000, vendor: 'ABC Electronics Ltd' }
      },
      {
        id: '2',
        type: 'po_approved',
        ...
        description: 'approved purchase order PO-2024-002',
        timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000), // 2 hours ago
        metadata: { amount: 150000, previousStatus: 'Pending' }
      },
      {
        id: '3',
        type: 'vendor_added',
        ...
        description: 'added a new vendor XYZ Suppliers',
        timestamp: new Date(Date.now() - 4 * 60 * 60 * 1000), // 4 hours ago
        metadata: { gst: '22BBBBB0000B1Z5', phone: '9876543211' }
      },
      {
        id: '4',
        type: 'comment_added',
        ...
        description: 'added a comment to PO-2024-001',
        timestamp: new Date(Date.now() - 6 * 60 * 60 * 1000), // 6 hours ago
        metadata: { comment: 'Please expedite the delivery' }
      },
      {
        id: '5',
        type: 'po_shipped',
        ...
        description: 'marked PO-2024-003 as shipped',
      ...
      },
      {
        ...
        description: 'rejected purchase order PO-2024-004',
        timestamp: new Date(Date.now() - 24 * 60 * 60 * 1000), // 1 day ago
        metadata: { reason: 'Budget constraints', amount: 500000 }
      },
      {
        id: '8',
        type: 'po_received',
        ...
        description: 'marked PO-2024-005 as received',
        timestamp: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000), // 2 days ago
        metadata: { deliveryDate: new Date().toISOString() }
      }
    ];
